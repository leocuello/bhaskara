#1) Dar informacion precisa al usuario, cambiar primer, segundo, tercer numero por "la variable cuadrática", "variable lineal", "término independiente"
a = int(input("Introduce el primer número: "))
b = int(input("Introduce el segundo número: "))
c = int(input("Introduce el tercer número: "))
#2) Validar que sean números enteros (Creo que con WHILE)
...
#5) Veo 2 bloqoes parecidos, para calcular X e Y, no es claro
...
#6) Usar nombre de variables representativas y claras
